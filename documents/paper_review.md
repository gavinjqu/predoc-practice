...
| Kenneth Arrow | 1963 | Normative analysis medical care | Corollary of optimality theorems | 1st - if competitive equilibrium exist, it's the pareto outcome, 2nd - if no increasing returns in production, then every optimal state is a competitive equilibrium. Supply and demand of medical care comparatively to other markets | Healthcare market angle of labor econ | 
