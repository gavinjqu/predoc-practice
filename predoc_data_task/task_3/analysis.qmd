...
```{python}
print(f"df_tw rows: {len(df_tw)}")
print(f"df_tw_inc rows: {len(df_tw_inc)}")
print(f"income > 0 count: {(df_tw_inc['income'] > 0).sum()}")
print(df_tw.groupby('year')['income'].apply(lambda x: x.notna().sum()))
```
